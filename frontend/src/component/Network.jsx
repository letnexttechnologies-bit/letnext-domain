...
export default function Network() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        Swal.fire("✅ Success!", "Network & Security registration submitted successfully.", "success");
        setFormData({
          fullName: "",
          email: "",
          mobileCode: "+91",
  ...
  return (
    <div className="course-container">
      ...
      <div className="course-left">
        <img src="/network.jpg" alt="Network & Security" className="course-img" />
        ...
        <ul>
          ...
          <li>Tools like Kali Linux, Wireshark</li>
          <li>Cyber Laws</li>
        </ul>
        <p className="wow">Protect digital systems from cyber threats.</p>
