...
export default function Blockchain() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        Swal.fire("✅ Success!", "Blockchain form submitted successfully.", "success");
        setFormData({
          fullName: "",
          email: "",
          mobileCode: "+91",
  ...
  return (
    <div className="course-container">
      ...
      <div className="course-left">
        ...
        <h3>You'll Learn</h3>
        <ul>
          <li>Fundamentals of blockchain and distributed ledger technology</li>
          <li>Cryptographic principles behind blockchain security</li>
          <li>Consensus mechanisms (Proof of Work, Proof of Stake, etc.)</li>
          <li>Smart contracts and decentralized applications (DApps)</li>
          <li>Use cases in finance, supply chain, healthcare, and government</li>
        </ul>
        <p className="wow">Gain expertise in blockchain development and decentralized systems.</p>
