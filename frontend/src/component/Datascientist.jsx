  ...
  return (
    <div className="course-container">
      ...
      <div className="course-left">
        ...
        <h3>You'll Learn</h3>
        <ul>
          <li>Efficient data cleaning and transformation</li>
          <li>Advanced formulas & functions</li>
          <li>PivotTables & Power Query</li>
          <li>Intro to Power BI / Power Pivot</li>
          <li>Excel for statistics & forecasting</li>
          <li>Macros & VBA automation</li>
          <li>Best practices for presenting data</li>
        </ul>
        <p className="wow">
          Learn to analyze, visualize and extract insights from data.
        </p>
