  ...
  return (
    <div className="course-container">
      ...
      <div className="course-left">
        ...
        <h3>You'll Learn</h3>
        <ul>
          <li>Core concepts of cloud computing: IaaS, PaaS, SaaS</li>
          <li>Public, private, hybrid, and multi-cloud architectures</li>
          <li>Virtual machines, containers, and serverless computing</li>
          <li>Cloud storage options and use cases</li>
          <li>Networking in the cloud (VPC, subnets, load balancing)</li>
        </ul>
        <p className="wow">
          Master cloud infrastructure and scalable applications.
        </p>
      ...
      <div className="course-right">
        ...
        <form onSubmit={handleSubmit} className="course-form">
          ...
          >
            ...
            {Array.from({ length: currentYear - 1979 }, (_, i) => currentYear - i).map(
              (year) => (
