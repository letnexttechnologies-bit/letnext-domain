  ...
  return (
    <div className="webdesigner-wrapper">
      <section className="webdesigner-section">
        ...
        <h2 className="webdesigner-title">Digital Marketing Portfolio</h2>
        <p className="webdesigner-desc">
          Here are some screenshots of our Digital Marketing projects:
        </p>

        <div className="screenshot-grid">
          <div
            className="screenshot-card"
            onClick={() => openFullscreen("/dig1.jpg")}
          >
          ...
          <div
            className="screenshot-card"
            onClick={() => openFullscreen("/dig2.jpg")}
          >
          ...
          <div
            className="screenshot-card"
            onClick={() => openFullscreen("/dig3.jpg")}
          >
