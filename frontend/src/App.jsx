  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route
          path="/uiUxDesigner/uiux-design-company-in-erode"
        ...
        />
        <Route
          path="/photographer/photograph-company-in-erode"
          element={<Photographer />}
        />
        <Route
          path="/videographer/videograph-company-in-erode"
        ...
        <Route
          path="/embbeded/embbeded-company-in-erode"
          element={<Embbeded />}
        />
        ...
        <Route
          path="/fullstack/full-stack-company-in-erode"
          element={<Fullstack />}
        />
        <Route path="/seo/seo-company-in-erode" element={<Seo />} />
        <Route
          path="/datascientist/data-scientist-company-in-erode"
          element={<Datascientist />}
        />
        <Route
          path="/cloudengineer/cloud-engineer-company-in-erode"
          element={<Cloudengineer />}
        />
        <Route
          path="/mlengineer/ml-engineer-company-in-erode"
          element={<Mlengineer />}
        />
        <Route path="/uiux/uiux-design-company-in-erode" element={<Uiux />} />
        <Route
          path="/mobile/mobile-development-company-in-erode"
          element={<Mobile />}
        />
        <Route path="/network/network-company-in-erode" element={<Network />} />
        <Route
          path="/embedded/embedded-company-in-erode"
          element={<Embedded />}
        />
        <Route
          path="/blockchain/blockchain-company-in-erode"
          element={<Blockchain />}
        />
